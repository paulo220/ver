...
const { fetchText, getBase64, createExif } = require('./armor/funcoes/fetcher');
...
const { wait, getExtension, h2k, generateMessageID, getGroupAdmins, getRandom, banner, banner2, banner3, infopd, success, start, close, temporizador, cmdadd, addMetadata, chyt, getBuffer, fetchJson } = require('./armor/funcoes/functions.js'); // FUNÇÕES NESCESSARIAS PRA FUNFAR ALGUMAS COISAS
...
const X9Visu = JSON.parse(fs.readFileSync("./datab/grupos/x9visu.json"))
