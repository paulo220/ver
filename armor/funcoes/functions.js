...
var corzinhas = ["blue","magenta","blueBright","magentaBright"]
...
const getGlobalSpinner = () => {
  if(!globalSpinner) globalSpinner = new spin({ color: 'magenta', succeedColor: 'purple', spinner});
  return globalSpinner;
}

const getGlobalSpinner2 = () => {
  if(!globalSpinner2) globalSpinner2 = new spin({ color: 'magenta', succeedColor: 'purple', spinner2});
...
authorname = 'ANYA-BOT-V1'
packname = '-AB-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-M.S-'; if (!author) author = 'ANYA-BOT';	
...
module.exports = { start2, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, infopd, success, close, addATM, addKoinUser, checkATMuser, temporizador, color, recognize, bgcolor, cmdadd, isFiltered, addFilter, addLimit, getLimit, addMetadata, chyt, getExtension}
